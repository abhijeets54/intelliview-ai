...
const InterviewItemCard = ({ interview }) => {
  ...
  return (
    <div className="relative border shadow-sm rounded-sm p-3 hover:shadow-md transition-shadow duration-300">
      {/* Delete button in the top-right corner */}
      <Button
        size="sm"
        variant="outline"
        className="absolute top-2 right-2 flex items-center justify-center hover:bg-red-50"
